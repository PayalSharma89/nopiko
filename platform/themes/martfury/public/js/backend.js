...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    var $formSearch = $(document).find('.bb-product-form-filter');
    ...
    $(document).on('click', '.ps-product-list .nav-item a', function (e) {
      ...
      $.ajax({
        ...
        success: function success(res) {
          ...
          var $target = $tabContent.find('.owl-slider');
    ...
    var $productListing = $(document).find('.ps-products-listing');
